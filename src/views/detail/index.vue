...
<script type="text/ecmascript-6">
  ...
  export default{
      ...
      addShopCar() {
        ...
        var parabola = new Parabola({
          ...
          onFinish (pos) {
            ...
            // 再使用 ShopCarTool 构造函数里面的 add方法
            // 结束时 加入购物车 this.shopCar 添加了一个商品 调用 ShopCarTool里面的方法 
            root.shopCar.add( root.info )
            console.log(JSON.stringify( root.info))
          }
        });
    ...
    mounted() {
      //实例化一个对象 this.shopCar 再使用 ShopCarTool 构造函数里面的方法
