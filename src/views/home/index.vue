.<template>
 <div class="app-init home-index">
   <header class="public-header">
      <form action="" class="search-box clear">
          <div class="fl logo">
      ...
      <nav class="menu-box scroll-box-x noscroll">
          <ul class="wrap-box clear">
            <li class="item" :class="{'active':index == navListActiveIndex}" v-for="(item,index) in navList" :key="index" @click="navListActiveIndex = index">
                <span>{{ item.name}}</span>
            </li>
          </ul>
      </nav>
   ...
   <div ref="view01" class="app-init scroll-box tab-box mi-tj footer-hack" v-show="navListActiveIndex == 0">
        ...
        <div class="nav-mi-tj ">
            <ul class="clear">
                <li @click="$router.openPage('/pay')">
                    <img src="http://oz3tayfme.bkt.clouddn.com/show.liluo.cc/2018011022292984819.png" alt="">
                </li>
                <li @click="$router.openPage('/pay')">
                    <img src="http://oz3tayfme.bkt.clouddn.com/show.liluo.cc/2018011022292984819.png" alt="">
                </li>
...
<style lang="sass">
  ...
  .home-index .tab-box
    top: 2.5rem
  .home-index .tab-box.mi-tj .nav-mi-tj ul li
      float: left
      display: block
      width:  25%
  .home-index .shop-box
